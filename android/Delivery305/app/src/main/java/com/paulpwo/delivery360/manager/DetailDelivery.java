...
public class DetailDelivery extends BaseSpiceActivity implements publicOKhttp {
    ...
    private void finishDelivery(){
        new AlertDialog.Builder(DetailDelivery.this)
                .setTitle("Finish")
                .setMessage("Are yousure to end this item" )
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        finishDelivery = true;
                        Helpers.getInstance().finishDelivery(DetailDelivery.this,id, DetailDelivery.this);
                        //callWebService();
                    }
                })
    ...
    private AlertDialog chooseDelivery(){
        ...
        AlertDialog dialog;
        choosetime="00:05:00";
        AlertDialog.Builder builder = new AlertDialog.Builder(DetailDelivery.this);
    ...
    private void chooseFinish(){
        Helpers.getInstance().chooseDelivery(DetailDelivery.this,id,choosetime,DetailDelivery.this);
        ...
        new AlertDialog.Builder(DetailDelivery.this)
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (ActivityCompat.checkSelfPermission(DetailDelivery.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
    ...
    private void callWebService(){
        if(Helpers.isOnline(getBaseContext())){
            ...
            Toast.makeText(DetailDelivery.this, "Check internet connection and re entry", Toast.LENGTH_SHORT).show();
        }
    ...
    private void updateList(DriverDelivery response){
       ...
       String tmp = Helpers.getInstance().readID(DetailDelivery.this);
        ...
        if(choose){
            if(response.code() != 404){
                ...
                new Thread()
                {
                    public void run()
                    {
                        DetailDelivery.this.runOnUiThread(new Runnable()
                        {
                            public void run()
                            {
                                Toast.makeText(DetailDelivery.this, "Sorry, could not be assigned this delivery." +
