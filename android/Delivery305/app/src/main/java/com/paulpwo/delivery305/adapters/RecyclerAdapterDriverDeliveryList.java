...
import com.paulpwo.delivery305.driver.DriverDetailDelivery;
...
public class RecyclerAdapterDriverDeliveryList extends
        RecyclerView.Adapter<RecyclerAdapterDriverDeliveryList.RecyclerViewHolder>  {
    ...
    public void onBindViewHolder(RecyclerViewHolder holder, int position) {
        holder._time.setText(driverDeliveries.get(position).getTime());
        holder._address.setText(driverDeliveries.get(position).getAddress());
        String status = driverDeliveries.get(position).getStatus();
        holder._restaurant.setText(driverDeliveries.get(position).getRestaurant());
        holder._id.setText(driverDeliveries.get(position).getId());
    ...
    public int getItemCount() {
        return driverDeliveries.size();
    }
    public void removeItem(int position) {
        driverDeliveries.remove(position);
