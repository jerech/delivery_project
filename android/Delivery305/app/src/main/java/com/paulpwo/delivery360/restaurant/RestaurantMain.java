...
import com.paulpwo.delivery360.request.RetrofitSpiceRequestDelivery;
...
public class RestaurantMain extends BaseFragmentSpice implements SwipeRefreshLayout.OnRefreshListener, DatePickerDialog.OnDateSetListener {
    ...
    public void onDateSet(DatePickerDialog datePickerDialog, int year, int month, int day) {
        ...
        dateSelected = formatDate.format(calendar.getTime());
    ...
    private void updateList(Deliverys.List deliverys){
       ...
       /* if(this.deliverys!=null) {
        ...
        if(!dateSelected.isEmpty()) {
            Calendar calendar = Calendar.getInstance();
            try {
                calendar.setTime(formatDate.parse(dateSelected));
