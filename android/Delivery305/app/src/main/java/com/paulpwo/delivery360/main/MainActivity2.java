...
import com.paulpwo.delivery360.driver.DriverListAvailable;
...
import com.paulpwo.delivery360.manager.ManagerViewDrivers;
import com.paulpwo.delivery360.restaurant.RestaurantHistory;
import com.paulpwo.delivery360.restaurant.RestaurantMain;
import com.paulpwo.delivery360.restaurant.Restaurant_New_Delivery;
import com.paulpwo.delivery360.utils.AppBarStateChangeListener;
...
public class MainActivity2 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,
    ...
    String phone;
           ...
           public Button ICON__COUNTER;
            ...
            @Override
            public void showMassege(boolean result) {
                if(result){
                    // Toast.makeText(c, "The delivery was created correctly", Toast.LENGTH_LONG).show();
                    new AlertDialog.Builder(context)
                            .setTitle("Delivery")
                            .setMessage("The delivery was created correctly!")
                    ...
                    new AlertDialog.Builder(context)
                            .setTitle("Delivery")
                            .setMessage("An error occurred while creating the delivery!")
                            .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                }
                            })
    ...
    private BroadcastReceiver myReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (myParam != null) {
                ...
                if(myParam.toString().equalsIgnoreCase("driver_list_delivery")){
                    if(typeAccount==2) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        if(typeAccount ==1){
            ...
            Helpers.getInstance().setOnLine(getApplicationContext());
 ...
 */
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        }  /*else if (id == R.id.nav_deliveries_history) {
            Intent intent = new Intent(this, ManagerDeliveryHistoty.class);
    ...
    private void createFastRequest() {
        ...
        Toast.makeText(getApplicationContext(), "Creating delivery", Toast.LENGTH_LONG).show();

        if (Helpers.isOnline(getApplicationContext())) {

            Helpers.getInstance().SendnewDelivery(this, getApplicationContext(),
                    "There are a delivery waiting for you.",
                    "No comment", null);
        } else {
            Toast.makeText(getApplicationContext(), "Error creating delivery. Check your connection.", Toast.LENGTH_LONG).show();
        }
...
/*        com.getbase.floatingactionbutton.FloatingActionButton menuNotice = new com.getbase.floatingactionbutton.FloatingActionButton(MainActivity2.this);
        ...
        final com.getbase.floatingactionbutton.FloatingActionButton menuStats = new com.getbase.floatingactionbutton.FloatingActionButton(MainActivity2.this);
        menuStats.setTitle("Stats deliveries");
        menuStats.setColorNormalResId(R.color.blue_semi_transparent);
        menuStats.setColorPressedResId(R.color.blue_semi_transparent_pressed);
        menuStats.setIcon(R.drawable.ic_assessment_white_24dp);
        rightLabels.addButton(menuStats);
        menuStats.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                rightLabels.collapse();
                Intent i = new Intent(MainActivity2.this, ManagerDeliveryHistoty.class);
                i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(i);
            }
        });
    ...
    protected void onDestroy() {
        if(typeAccount==2) {
            Helpers.getInstance().setOffLine(getApplicationContext());
        }
        super.onDestroy();
