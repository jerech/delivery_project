...
import com.paulpwo.delivery305.driver.DriverNotifyNewDelivery;
import com.paulpwo.delivery305.driver.Profile_Drive;
...
import com.paulpwo.delivery305.restaurant.Restaurant_Profile;
...
*/
    ...
    *                   methods for manager
    */
    public void SendnewDelivery(final Context c , final String address, final String note, @Nullable String ID_RESTAURANT){
        RequestBody body;
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                new CustomTask().execute(c, response);
...
//        int hour = Integer.parseInt(time.
    ...
    private class CustomTask extends AsyncTask<Object, Void, Void> {
        Context c;
        Response response;
        String id_delivery;
