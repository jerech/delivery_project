...
public class MyService extends Service implements
   ...
   // static final int UPDATE_INTERVAL = 2000;
    ...
    private void doSomethingRepeatedly(){
        timer.scheduleAtFixedRate(new TimerTask(){
            ...
            public void run() {
                ...
                new DoBackgroundTaskDriverListDelivery().execute("OK");
            }

        },0, Constants.UPDATE_INTERVAL_SERVICE_2);
    ...
    private class DoBackgroundTaskDriverListDelivery extends AsyncTask<Object, Void, Void> {
        ...
        protected Void doInBackground(Object... arg0) {
            ...
            if(driver){
                Intent broadcastIntent = new Intent();
                broadcastIntent.setAction("NOMBRE_DE_NUESTRA_ACTION");
                broadcastIntent.putExtra("parameter", "driver_list_delivery");
                getBaseContext().sendBroadcast(broadcastIntent);
            }
